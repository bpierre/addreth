// from https://github.com/rainbow-me/rainbowkit/blob/dbca8057dc8e5cee224a57bd519b4a61407bc507/packages/rainbowkit/src/components/Avatar/emojiAvatarForAddress.ts
const colors = [
  "#FC5C54",
  "#FFD95A",
  "#E95D72",
...
export function RainbowAvatar({ address }: { address: string }) {
